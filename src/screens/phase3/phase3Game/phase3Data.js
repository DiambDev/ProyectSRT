export const PHASE3 = {
  ...
  activity1Events: [
    { eventid: 4624, user: 'Admin_Sistema', time: '2026-09-15 08:01:12', type: 'Inicio de sesión', source: '192.168.1.10', sourceType: 'SEGURIDAD', status: 'INFO' },
    { eventid: 4656, user: 'Admin_Sistema', time: '2026-09-15 08:15:33', type: 'Acceso a archivo', source: '192.168.1.10', sourceType: 'SISTEMA', status: 'INFO' },
    ...
    { eventid: 4624, user: 'Servicio_Avanzado', time: '2026-09-15 10:47:55', type: 'Inicio de sesión', source: '203.0.113.42', sourceType: 'SEGURIDAD', status: 'ADVERTENCIA' },
    { eventid: 4656, user: 'Servicio_Avanzado', time: '2026-09-15 10:48:21', type: 'Acceso a archivo', source: '203.0.113.42', sourceType: 'SISTEMA', status: 'INFO' },
    { eventid: 4657, user: 'Servicio_Avanzado', time: '2026-09-15 10:52:14', type: 'Modificación de registro', source: '203.0.113.42', sourceType: 'SISTEMA', status: 'ADVERTENCIA' },
    ...
    { eventid: 4625, user: 'Invitado_Guest', time: '2026-09-15 11:30:45', type: 'Inicio de sesión', source: '10.0.0.55', sourceType: 'SEGURIDAD', status: 'ERROR' },
    ...
    { eventid: 4625, user: 'Invitado_Guest', time: '2026-09-15 12:01:10', type: 'Inicio de sesión', source: '10.0.0.55', sourceType: 'SEGURIDAD', status: 'ERROR' },
    { eventid: 4656, user: 'Servicio_Avanzado', time: '2026-09-15 12:15:33', type: 'Creación de archivo', source: '203.0.113.42', sourceType: 'APLICACIONES', status: 'INFO' },
    { eventid: 4624, user: 'Admin_Sistema', time: '2026-09-15 12:30:00', type: 'Inicio de sesión', source: '192.168.1.10', sourceType: 'SEGURIDAD', status: 'INFO' },
    { eventid: 4657, user: 'Servicio_Avanzado', time: '2026-09-15 13:02:48', type: 'Modificación de registro', source: '203.0.113.42', sourceType: 'SISTEMA', status: 'ADVERTENCIA' },
    { eventid: 4656, user: 'Admin_Sistema', time: '2026-09-15 13:15:22', type: 'Acceso a archivo', source: '192.168.1.10', sourceType: 'SISTEMA', status: 'INFO' },
    { eventid: 4625, user: 'Invitado_Guest', time: '2026-09-15 13:45:09', type: 'Inicio de sesión', source: '10.0.0.55', sourceType: 'SEGURIDAD', status: 'ERROR' },
    { eventid: 4624, user: 'Admin_Sistema', time: '2026-09-15 14:00:00', type: 'Inicio de sesión', source: '192.168.1.10', sourceType: 'SEGURIDAD', status: 'INFO' },
    { eventid: 4656, user: 'Servicio_Avanzado', time: '2026-09-15 14:22:17', type: 'Acceso a archivo', source: '203.0.113.42', sourceType: 'APLICACIONES', status: 'INFO' },
    ...
    { eventid: 4625, user: 'Invitado_Guest', time: '2026-09-15 15:10:33', type: 'Inicio de sesión', source: '10.0.0.55', sourceType: 'SEGURIDAD', status: 'ERROR' },
    { eventid: 4624, user: 'Admin_Sistema', time: '2026-09-15 15:30:00', type: 'Inicio de sesión', source: '192.168.1.10', sourceType: 'SEGURIDAD', status: 'INFO' },
  ],
